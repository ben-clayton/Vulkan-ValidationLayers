...
TEST_F(VkLayerTest, SyncCopyImageHazards) {
    ...
    VkImageSubresourceRange layer0_subresource_range{VK_IMAGE_ASPECT_COLOR_BIT, 0, 1, 0, 1};
    VkImageSubresourceRange layer1_subresource_range{VK_IMAGE_ASPECT_COLOR_BIT, 0, 1, 1, 1};
